...
import { LineChart, GaugeChart, PieChart, BarChart, HeatmapChart } from "echarts/charts"
import { GridComponent, TooltipComponent, LegendComponent, TitleComponent, ToolboxComponent, GeoComponent, DataZoomComponent, CalendarComponent,VisualMapComponent } from "echarts/components"
...
echarts.use([CanvasRenderer, LineChart, GaugeChart, PieChart, BarChart, HeatmapChart, GridComponent, TooltipComponent, LegendComponent, TitleComponent, ToolboxComponent, GeoComponent, DataZoomComponent, CalendarComponent, VisualMapComponent])
const e1_option = ref({
  grid: {
    width: "80%",
    height: "80%",
    ...
    <div class="w-3/4 flex flex-col gap-y-5">
      <div class="flex justify-evenly gap-x-3">
        <div class="bg-white w-1/3 h-40 rounded-3xl p-2 grid grid-cols-12 grid-rows-6 shadow-xl shadow-light-600">
          <p class="col-start-1 col-span-5 row-start-2 row-span-2 text-lg text-gray-400 m-auto"> 访问量 </p>
        ...
        <div class="bg-white w-1/3 h-40 rounded-3xl grid grid-cols-12 grid-rows-6 shadow-xl shadow-light-600">
          <p class="col-start-1 col-span-5 row-start-2 row-span-2 text-lg text-gray-400 m-auto"> 月收入 </p>
          <div class="col-start-2 col-span-3 row-start-4 row-span-2 flex items-center justify-center">
      ...
      <div>
        <div class="bg-white w-full h-60 rounded-lg grid grid-cols-12 grid-rows-6 shadow-xl shadow-light-600">
          <div class="col-start-1 col-span-12 row-start-1 row-span-6">
            <VbenTable :columns="operatorColumns" :data="operatorData"
              :options="{ border: 'none', size: 'mini', stripe: true, round: true, maxHeight: 200 }"></VbenTable>
          </div>
        </div>
      </div>
    </div>
