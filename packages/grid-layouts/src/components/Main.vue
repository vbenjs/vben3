...
const { headerWidth, headerHeight } = storeToRefs(useLayoutHeader() as StoreGeneric)
const { setAppConfig, setSidebar } = useAppConfig()

// console.log(sidebar.value.bgColor)
...
<template>
  <main class="vben-grid-layout-main">
    ...
    <div>
<!--      useAppConfig : {{ sidebar }}-->
    </div>
    <div @click.stop="setSidebar({  width: 365423463136132121212})">
      sidebar change
    </div>
    <!--    <RouterView />-->
  </main>
